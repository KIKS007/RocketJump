...
////// Lighting:
                ...
                float node_9406 = 0.0;
                float3 finalColor = (lerp(lerp(_MainTex_var.rgb,(_MainTex_var.rgb*(1.0 - _LightColor0.rgb)),_ShadowOpacity),_MainTex_var.rgb,step(_ShadowSize,node_5530))+lerp(float3(node_9406,node_9406,node_9406),(step(_HighlightSize,node_5530)*_LightColor0.rgb),_HighlightOpacity));
